"""
This class contents the unit tests for DatabaseManager class
"""
import unittest
...
class database_manager_test(unittest.TestCase):
    ...
    def test_insert_element(self):
        """
        This test validates the insert an element on db
        """
    ...
    def test_update_element(self):
        """
        This test validates the update an element on db
        """
        test_db_manager = DatabaseManager()
