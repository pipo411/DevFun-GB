...
requires = IS_ALPHANUMERIC(error_message='﹐ust be alphanumeric!')
# Validator verifies that the value of the field contains a valid date

requires = IS_DATE(format=T('%Y-%m-%d'),
                   error_message='﹐ust be  YYYY-MM-DD!')
...
class IS_DATE(object):
    def __init__(self, format='%Y-%m-%d', error_message='﹐ust be  YYYY-MM-DD!'):
        self.format = format
